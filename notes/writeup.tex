...
\section{Dimensionless form of an equation}
\subsection{Definition}
...
\item Different choices of scales lead to different dimensionless equations
  ...
  \begin{equation}
    \begin{aligned}
      ...
      \bar{y} &= 1 \text{ at } \bar{t} = 0 \\
      \bar{\eta} &= \frac{\eta\lambda}{r} \text{ dimensionless}
    \end{aligned}
  \end{equation}
...
\item Solutions of dimensionful and dimensionless equations are equivalent
  ...
  \begin{equation}
    \text{dim-full soln} \leftrightarrow
    \begin{aligned}
      \bar{y} &= y/y_c \\
      \bar{t} &= t/t_c \\
    \end{aligned}
...
\begin{equation}
  \begin{aligned}
    \text{dim-full eq} \frac{d^2u}{dt^2} = au + bu^2 + ce^{-u/d}
  \end{aligned}
\end{equation}
Can't compare $a$, $b$, $c$, $d$ since dimensions are different.

Dimensionless equations
\begin{equation}
  \frac{d^2\bar{u}}{d\bar{t^2}} = \bar{a} \bar{u} + \bar{b} \bar{u^2} + \bar{c}e^{-\bar{u}/\bar{d}}
\end{equation}
can compare $\bar{a}$, $\bar{b}$, $\bar{c}$, $\bar{d}$ since dimensionless.

\subsection{Example}
Vertical motion of a ball:

Name the variables in \cref{fig:ball-model}
\begin{figure}
  \centering
...
Where
\begin{equation}
  x=0,\quad \frac{dx}{dt} = v_0 \text{ at } t=0
\end{equation}
