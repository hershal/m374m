...
\begin{align*}
  \od[2]{}{t}x(t,\epsilon) + x(t,\epsilon) + \epsilon x^3(t,\epsilon) = 0, t\ge 0 & \text{ODE} \\
  \od{}{t}x(0,t)=0,\quad x(0,\epsilon)-1=0 & \text{ICs}
\end{align*}
...
\begin{align*}
  ...
  &= x^3_0(t) + \epsilon[2x_0^2(t)x_1(t)] + \cdots \\
\end{align*}
...
\end{align*}
Recurrence relations, etc. Reference picture from class. \todo{fill prev
  equation}
Solution for $x_1(t)$
\begin{align}
  \label{eq:ode}
