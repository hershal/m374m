...
\begin{equation}
  ...
  {(x+1)}^3-\epsilon x=0.
\end{equation}
Substituting \cref{eq:3.1.7-relation} into \cref{eq:3.1.7-rewrite} and expanding
yields
\begin{equation*}
...
\begin{align*}
  ...
  \epsilon_0 &:\quad \left(x_0+1\right){}^3=0, \\
  \epsilon_1 &:\quad 3 x_1 x_0^2+\left(6 x_1-1\right) x_0+3 x_1=0, \\
  \epsilon_2 &:\quad 3 x_2 \left(x_0+1\right){}^2+3 x_1^2 \left(x_0+1\right)-x_1=0, \\
  \epsilon_3 &:\quad x_1^3+6 \left(x_0+1\right) x_2 x_1-x_2=0, \\
  \epsilon_4 &:\quad 3 x_2 \left(x_1^2+\left(x_0+1\right) x_2\right)=0, \\
  \epsilon_5 &:\quad 3 x_1 x_2^2=0 \\
  \epsilon_6 &:\quad x_2^2+\cdots = 0 \\
\end{align*}
Each equation gives us a better picture of the solution: $\epsilon_0\implies
x_0=-1$; $\epsilon_1$ yields no insights; $\epsilon_2 \implies x_2=0$;
