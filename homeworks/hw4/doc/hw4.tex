...
\begin{figure}
      ...
      \begin{axis}[width=12cm, height=12cm, domain=-3:3, xmin=-3, xmax=3,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 1 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-1-1-u-\i.mat};
        }
      ...
      \begin{axis}[width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-1-1-x-\i.mat};
        }
  ...
  \begin{tikzpicture}
      \begin{axis}[width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-1-1-y-\i.mat};
        }
        \addplot3[gray, dashed, very thin] coordinates {(0,0,0) (8,0,0)};
      \end{axis}
    \end{tikzpicture}
...
\begin{figure}
  ...
  \begin{subfigure}{0.9\textwidth}
  \begin{tikzpicture}
      \begin{axis}[width=12cm, height=12cm, domain=-2:2, xmin=-2, xmax=2,
        ymin=-2, ymax=2, % xtick={-1,-0.5,0,0.5,1}, ytick={-1,-0.5,0,0.5,1},
        view={0}{90}, xlabel=$x$, ylabel=$y$]
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 1 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-1-u-\i.mat};
        }
  ...
  \begin{tikzpicture}
      \begin{axis}[width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-1-x-\i.mat};
        }
        \addplot3[gray, dashed, very thin] coordinates {(0,0,0) (8,0,0)};
      \end{axis}
    \end{tikzpicture}
  ...
  \begin{tikzpicture}
      \begin{axis}[width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-1-y-\i.mat};
        }
        \addplot3[gray, dashed, very thin] coordinates {(0,0,0) (8,0,0)};
      \end{axis}
    \end{tikzpicture}
    \caption{$y$ vs $t$}
    \label{fig:minilab-2-1-y}
  \end{subfigure}
...
\begin{figure}
  ...
  \begin{tikzpicture}
      \begin{axis}[restrict y to domain=-4000:4000, width=12cm, height=12cm, domain=-4000:4000, xmin=-4000, xmax=4000,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 1 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-2-u-\i.mat};
        }
  ...
  \begin{tikzpicture}
      \begin{axis}[restrict y to domain=-1000:1000, width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-2-x-\i.mat};
        }
  ...
  \begin{tikzpicture}
      \begin{axis}[restrict y to domain=-1000:1000, width=8cm, height=8cm, domain=0:6, xmin=0, xmax=6,
        ...
        \foreach \i in {1,...,4} {
          \addplot3[decoration={markings, mark=between positions 0.1 and 0.9 step 4em with
            {\arrow [scale=1.5]{stealth}} }, postaction=decorate] table {minilab-2-2-y-\i.mat};
        }
        \addplot3[gray, dashed, very thin] coordinates {(0,0,0) (10,0,0)};
      \end{axis}
    \end{tikzpicture}
