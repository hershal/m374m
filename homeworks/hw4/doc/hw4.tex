...
\begin{figure}
  ...
  \begin{tikzpicture}
      \begin{axis}[width=12cm, height=12cm, domain=-1:1, xmin=-1, xmax=1,
        ymin=-1, ymax=1, xtick={-1,-0.5,0,0.5,1}, ytick={-1,-0.5,0,0.5,1},
        ...
        \addplot3[gray, quiver={u={3*y}, v={-4*x}, scale arrows=0.08}, -stealth,samples=15]{0};
        % \addplot3[gray, dashed, very thin] coordinates {(-1,0,0) (1,0,0)};
        % \addplot3[gray, dashed, very thin] coordinates {(0,-1,0) (0,1,0)};
      \end{axis}
    \end{tikzpicture}
