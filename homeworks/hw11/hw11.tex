...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
This implies that $B=n2\pi$, where $n$ is some integer. Furthermore
\begin{equation*}
  \begin{aligned}
    ...
    0 &= r\cos(A+n2\pi) &\quad r &= r\sin(A+n2\pi) &\quad h &=C \\
  \end{aligned}
\end{equation*}
This implies $A=\pi(4n+1)/2$ and $z(1)=h$. Thus we may conclude that there is a
family of solutions in $\theta(t)=At+b$ and $z(t)=Ct+D$ where $A=n2/pi$,
$B=\pi(4n+1)/2$, $C=h$, and $D=0$, $\forall n\in\mathbb{Z}$.
\subsection{c}
\subsubsection*{Problem}
